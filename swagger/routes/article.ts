  ...
  '/api/v1/articles/': {
    post: {
      ...
      responses: {
        ...
        401: {
          description: 'Unauthorized; Ensure the Bearer token is valid and included',
        },
        409: { description: 'Conflict; Likely due to duplicate article data' },
        422: {
          description: 'Unprocessable entities; Validation failed for provided data',
        },
        500: {
  ...
  '/api/v1/articles/{id}': {
    get: {
      ...
      responses: {
        ...
        400: {
          description: 'Bad request, invalid query parameters or missing article',
        },
        401: { description: 'Unauthorized, invalid credentials or token' },
    ...
    put: {
      ...
      responses: {
        ...
        404: { description: 'Article not found' },
        409: {
          description: 'Conflict, attempting to update with conflicting data',
        },
